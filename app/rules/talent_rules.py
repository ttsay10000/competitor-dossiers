...
# Order matters: Business & Strategy before Property operations so virtual/central roles match first.
FUNCTIONAL_AREA_KEYWORDS = [
    ...
    ("Business & Strategy", [
        ...
        "guest experience associate", "overnight guest experience", "leasing agent", "leasing specialist",
        "customer success", "reservations associate", "virtual assistant",
    ]),
    ("Property operations", [
